...
public class ${pojo.shortName}DaoJpa extends PagingationSupportForJPA<${pojo.shortName}, ${pojo.getJavaTypeName(pojo.identifierProperty, jdk5)}> implements ${pojo.shortName}Dao {
