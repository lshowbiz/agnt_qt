...
<body>
    ...
    <div class="cooperation mgtb10 clearfix">
        ...
        <div class="cooperationCon fr">
            ...
            <div class="yourCPs fr"><a href="inwSuggestionReply.html?id=${inwDemand.id }&differenceInw=system">查看您的合作方案<ng:locale key=""/></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="inwSuggestionform.html?id=${inwDemand.id }&differenceInw=system" class="colorCS bold"><ng:locale key="submitYourCooperationPrograms"/></a></div>
        </div>
    </div>
    </c:forEach>
