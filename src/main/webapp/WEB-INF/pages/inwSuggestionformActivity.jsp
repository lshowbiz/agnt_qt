...
<form:form commandName="inwSuggestion"  method="post" action="inwSuggestionformActivity" id="inwSuggestionId">
    ...
    <table width="100%">
           ...
           <tr style="line-height:300%">
		    ...
		    <td width="20%" nowrap="nowrap"><input type="submit" class="btn_common ft14 fr" name="save" id="saveId" value="<ng:locale key="operation.button.save"/>" /></td>
  ...
  <script type="text/javascript">
       ...
       //返回按钮的方法
       function goBack(){
          window.location.href="inwDemandsActivity.html";
       }
