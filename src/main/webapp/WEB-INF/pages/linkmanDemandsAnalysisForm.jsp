...
<div class="cont">	
	...
	<div class="mt">
    <form:form commandName="linkmanDemand" action="linkmanDemandsAnalysisForm" method="post" id="linkmanDemandsAnalysisForm" onsubmit="if(isFormPosted()){return true;}{return false;}">
        <table class="form_edit_table">
            ...
            <tr>
            <td><ng:locale key="linkmanDemand.executionTime"/>：</td>
            <td>                           
            ...
            <tr>
                 <td style="display:none"><form:input  path="buyGoods"  id="buyGoods" /></td>
                 <td style="display:none"><form:input  path="buyQuantity"  id="buyQuantity" /></td>
                 <td style="display:none"><form:input  path="buyTime"  id="buyTime" /></td>
                 <td style="display:none"><form:input  path="productExperience"  id="productExperience" /></td>
                 <td style="display:none"><form:input  path="usingFeedback"  id="usingFeedback" /></td>
            </tr>
            <tr>
       ...
       <div class="tc"><input type="hidden" name="demandFunction" value="" id="demandFunction"/>
                	<form:input path="id" id="id" cssClass="text medium" cssStyle="display:none"/>
    ...
    <script>
     ...
     function getLinkmanById(){
      ...
      //返回按钮的方法  
      function goBack(){
            window.location.href="linkmanDemandAnalysisQuery";
      } 
