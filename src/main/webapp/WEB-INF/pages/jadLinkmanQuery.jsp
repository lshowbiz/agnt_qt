...
<body>
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="2">
							...
							<button id="add" type="button" onclick="linkmanAdd()" style="margin-left:10px;"><ng:locale key="operation.button.add"/></button>
						</td>
					</tr>
				</tbody>
            </table>
	...
	<div id="kkk"></div>
	<div class="mt">
	<table class="prod mt" id="LinkmanQueryId" >
			...
			<tr class="bg-c gry3">
				...
				<td>
					<c:if test="${linkmanOb.customer_focus=='Y' }">
						<a href="#"  title="特别关注"><img src="images/treeimages/tb.gif" style="cursor:pointer;"/></a>
					</c:if>
					<c:if test="${linkmanOb.customer_focus!='Y' }">
						<a href="#"  title="普通关注"><img src="images/treeimages/pt.gif" style="cursor:pointer;"/></a>
					</c:if>
				</td>
				...
				<td>
					<a href="#" title="详情"><img src="images/search.gif" style="cursor:pointer;" onclick="window.location.href='jadLinkmanDetailQuery.html?id=${linkmanOb.id }';" alt="查看"/>
					</a>&nbsp;&nbsp;
					<img src="images/pencil.gif" style="cursor:pointer;" onclick="window.location.href='jadLinkmanDetailQueryUpdate.html?id=${linkmanOb.id }';" alt="<ng:locale key="operation.button.edit"/>"/>
					&nbsp;&nbsp;
