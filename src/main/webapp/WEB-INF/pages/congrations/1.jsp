...
<body>
	<div class="wrap">
		<div class="mainBox">
			...
			<div class="titleCN">中脉綠寶石</div>
			<div class="titleEN">JM INTERNATIONAL EMERALD</div>
			<div class="cLetter"></div>
			
			<div class="contentCN">
				<p>尊敬的<span class="isText">${chineseName }</span>（先生/女士）：</p>
				<p>恭賀您榮膺<span class="textSp">中脉綠寶石</span>獎銜，同時也對您創造的輝煌業績表示深深的敬意!</p>
			...
			<div class="contentEN">
				...
				<p>Congratulations for awarded<span class="textSp textSpEN">JM INTERNATIONAL EMERALD</span>leadership title.We are proud of your extraordinary accomplishment.</p>
