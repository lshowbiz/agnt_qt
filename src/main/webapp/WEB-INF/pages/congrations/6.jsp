...
<body>
	<div class="wrap">
		<div class="mainBox">
			...
			<div class="cLogo tc"><img src="${ctx}/images/congrations/c_logo.jpg" alt="c_logo" /></div>		
			<div class="titleCN">中脉黑鑽</div>
			<div class="titleEN">JM INTERNATIONAL BLACK DIAMOND</div>
			<div class="cLetter"></div>
			
			<div class="contentCN">
				<p>尊敬的<span class="isText">${chineseName }</span>（先生/女士）：</p>
				<p>恭賀您榮膺<span class="textSp">中脉黑鑽</span>獎銜，同時也對您創造的輝煌成就表示崇高的敬意!</p>
