...
<body>
	<div class="wrap">
		<div class="mainBox">
			...
			<div class="cLogo tc"><img src="${ctx}/images/congrations/f_logo.jpg" alt="f_logo" /></div>
			<div class="titleCN">中脉皇冠特使</div>
			<div class="titleEN">JM INTERNATIONAL CROWN ENVOY</div>
			<div class="cLetter"></div>
			
			<div class="contentCN">
				<p>尊敬的<span class="isText">${chineseName }</span>（先生/女士）：</p>
				<p>恭賀您榮膺<span class="textSp">中脉皇冠特使</span>獎銜，同時也對您創造的輝煌業績表示深深的敬意!</p>
			...
			<div class="contentEN">
				...
				<p>Congratulations for awarded<span class="textSp textSpEN">JM INTERNATIONAL CROWN ENVOY</span>Leadership Title. We are proud of your extraordinary accomplishment.</p>
