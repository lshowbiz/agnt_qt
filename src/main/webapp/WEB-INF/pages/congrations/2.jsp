...
<body>
	<div class="wrap">
		<div class="mainBox">
			...
			<div class="titleCN">中脉紅寶石</div>
			<div class="titleEN">JM INTERNATIONAL RUBY</div>
			<div class="cLetter"></div>
			
			<div class="contentCN">
				<p>尊敬的<span class="isText">${chineseName }</span>（先生/女士）：</p>
				<p>恭賀您榮膺<span class="textSp">中脉紅寶石</span>獎銜，同時也對您創造的輝煌業績表示深深的敬意!</p>
			...
			<div class="contentEN">
				...
				<p>Congratulations for awarded<span class="textSp textSpEN">JM INTERNATIONAL RUBY</span>Leadership Title.We are proud of your extraordinary accomplishment.</p>
				<p>With your endless effort in pursuing your success,we are all deeply touch by your determination and strong desire in fulfilling your dreams.</p>
				<p>Success is a process of on going learning.We knew that with your willingness to compete,you will continne to overcome challenge in your career development.We wish you all the best in upgrading a wonderfullife.</p>
			</div>
