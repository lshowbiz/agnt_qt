...
<img style="display:none" src="images/indicator_smallwaitanim.gif" alt="Loading"  align="absmiddle" />
     <div class="cont2">
        ...
        <form method="get" action="jbdRecommendBonusTreeSelect" onsubmit="return validateOthers(this)" id="bdPeriodForm">
	...
	<p>
	服务网络:
	<a href="jbdRecommendBonusTreeSelect?strAction=bdRecommendBonusTreeQuery&formatedWeek=${param.formatedWeek }&userCode=${sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal.userCode }">
	${sessionScope.SPRING_SECURITY_CONTEXT.authentication.principal.userName }
	</a>
	<c:if test="${not empty upRecommendList}">
	<c:forEach items="${upRecommendList}" var="upRecommendRefVar">
	/ <a href="jbdRecommendBonusTreeSelect?strAction=bdRecommendBonusTreeQuery&formatedWeek=${param.formatedWeek }&userCode=${upRecommendRefVar.user_code }">
	...
	<table class="prod mt" id="tablemain" >
		<tbody class="list_tbody_header">
            <tr>
                ...
                <td><ng:locale key="miMember.recommendCount"/></td>
                <td><ng:locale key="bdday.pending_recommend_pv1"/></td>
                ...
                <td><ng:locale key="customerRecord.type"/></td>
               <%--  <td><ng:locale key="bdday.pending_recommend_pv"/></td> --%>
                <td>&nbsp;</td>
            </tr>
            </tbody>
            ...
            <tr class="bg-c gry3">
                ...
                <td><nobr><ng:code listCode="bd.cardtype" value="${jbdDayBonusVar.card_type }"/></nobr></td>
		...
		<%-- 	<c:if test="${doubleView=='1' }">
               ...
               <%--  <td><img src="images/bonus_tree/tree_person_pv.gif" border="0"/><fmt:formatNumber pattern="###,##0.00">${jbdDayBonusVar.pending_recommend_pv }</fmt:formatNumber></td> --%>
                <td><a href="jbdRecommendBonusTreeSelect?strAction=bdRecommendBonusTreeQuery&formatedWeek=${param.formatedWeek }&userCode=${jbdDayBonusVar.user_code }"><img src="images/bonus_tree/next_5.png" border="0"/></a></td>
            </tr>
            </c:forEach>
            </tbody>
    </table>
