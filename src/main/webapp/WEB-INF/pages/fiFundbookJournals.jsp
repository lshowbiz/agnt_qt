			...
			<div class="mt">	
				<table width="85%" class="mt" style="margin:0 auto; font-size:14px" >
					<tr>
						...
						<td><button id="search" type="button"  value="转入发展基金帐户" onclick="javascript:location.href='${pageContext.request.contextPath}/fiTransferFundbookform?bankbookType=1&transferType=3&destOther=0'">转入发展基金帐户</button></td>
						<td><button id="search" type="button" class="btn btn-success" value="转入定向基金帐户" onclick="javascript:location.href='${pageContext.request.contextPath}/fiTransferFundbookform?bankbookType=1&transferType=2&destOther=0'">转入定向基金帐户</button></td>
						<td><button id="search" type="button" class="btn btn-warning" value="转账给他人分红基金" onclick="javascript:location.href='${pageContext.request.contextPath}/fiTransferFundbookform?bankbookType=1&transferType=1&destOther=1'">转账给他人分红基金</button></td>
					</tr>
				</table>
			</div>
		</div>
...
<div class="cont2">
            <form method="get" action="${ctx}/fiFundbookJournals" id="searchForm">
                <table class="search_table mt" >
                        <tr>
                            ...
                            <td>
                            	<button id="search" type="button" onclick="searchF('${pageContext.request.contextPath}/fiFundbookJournals')">查询</button>
                            </td>
                        </tr>
                </table>
            </form>
