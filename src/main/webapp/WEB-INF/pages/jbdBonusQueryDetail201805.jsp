	...
	<table width="100%" class="personalInfoTab tdTr mgtb10">
		...
		<tbody>
			...
			<tr class="stripe">
				...
				<td>
					<security:authorize url="/app/jbdBonusEnquiryDetails">
						   <!-- 这里缺少权限设定的标语 -->
					 <a href="jbdBonusEnquiryDetails.html?userCode=${jbdMemberLinkCalcHist.userCode }&wweek=${jbdMemberLinkCalcHist.wweek }&type=ventureLeaderPv201805">
			...
			<tr>
				...
				<td>
					...
					<ng:locale  key="jbdMemberLinkCalcHist.successLeaderPv.pv.daishu"/>：
					</c:if>
					<c:if test="${jbdMemberLinkCalcHist.wweek>=201905}">
						领导奖(PV)：
					</c:if>
			...
			<tr  class="stripe">
				...
				<td>
					<security:authorize url="/app/jbdBonusEnquiryDetails">
						   <a href="jbdBonusEnquiryDetails.html?userCode=${jbdMemberLinkCalcHist.userCode }&wweek=${jbdMemberLinkCalcHist.wweek }&type=servicePv201607">
				   <ng:locale key="menu.editJbdMemberLinkCalcHis"/></a>
				   </security:authorize>
		...
		<c:if test="${jbdMemberLinkCalcHist.wweek <201905 }">
			<tr  class="stripe">
				...
				<td align="center"><security:authorize url="/app/jbdBonusEnquiryDetails">
						 <a href="jbdBonusEnquiryDetails.html?userCode=${jbdMemberLinkCalcHist.userCode }&wweek=${jbdMemberLinkCalcHist.wweek }&type=bdjPv201607">
						   <ng:locale key="menu.editJbdMemberLinkCalcHis"/>  </a>
			...
			<c:if test="${jbdMemberLinkCalcHist.wweek>=201905 }">
				...
				<tr class="stripe">
					...
					<td>
						<security:authorize url="/app/jbdBonusEnquiryDetails">
							<!-- 这里缺少权限设定的标语 -->
							<a href="jbdBonusEnquiryDetails.html?userCode=${jbdMemberLinkCalcHist.userCode }&wweek=${jbdMemberLinkCalcHist.wweek }&type=popularizeBonusPv">
								<ng:locale key="menu.editJbdMemberLinkCalcHis"/></a>
						</security:authorize>
					</td>
				</tr>
