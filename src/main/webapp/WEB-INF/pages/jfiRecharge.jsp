...
<div class="cont">
<form id="jfiRechargeForm" name="jfiRechargeForm" method="get" action="${pageContext.request.contextPath}/jfiRecharge.html" target="_blank">	
    <div class="bt mt">
		<h3 class="color2 ml">充值</h3>
	</div>
