...
a,img{border:0;}
/* outer */
#outer{height:200px;position:relative;overflow:hidden;background:#eee;border-radius:5px;border:1px solid #e5e5e5; margin-right:10px;margin-top:20px; }
#inner{display:block;height:200px;position:absolute;left:0;top:0;}
#inner li{display:block;height:200px;float:left;font-size:72px;line-height:200px;text-align:center;content:#666;background:#eee;}
...
#right{right:0;border-top-left-radius:10px;border-bottom-left-radius:10px;}
	...
	<div id="outer">
		<ul id="inner">
			<li><a href="#"><img id="s1" name="imggd" src="${FILE_URL }guaten/${images[0]}.jpg" style="width:100%" height="200" onclick="window.open('${links[0] }')"></a></li>
			<li><a href="#"><img id="s2" name="imggd" src="${FILE_URL }guaten/${images[1]}.jpg" style="width:100%" height="200" onclick="window.open('${links[1] }')"></a></li>
			<li><a href="#"><img id="s3" name="imggd" src="${FILE_URL }guaten/${images[2]}.jpg" style="width:100%" height="200" onclick="window.open('${links[2] }')"></a></li>
		</ul>
	</div>
