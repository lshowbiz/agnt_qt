...
@Entity
@Table(name="JBD_SEND_RECORD_HIST")

@XmlRootElement
public class JbdSendRecordHist extends BaseObject implements Serializable {
    private Long id;
    ...
    private Long validWeek;
    private Long freezeStatus;
    private Long beforeFreezeStatus;
    ...
    public Long getValidWeek() {
        return this.validWeek;
    }
    
    public void setValidWeek(Long validWeek) {
    ...
    public Long getBeforeFreezeStatus() {
        return this.beforeFreezeStatus;
    }
    
    public void setBeforeFreezeStatus(Long beforeFreezeStatus) {
    ...
    public boolean equals(Object o) {
        ...
        JbdSendRecordHist pojo = (JbdSendRecordHist) o;
