 ...
 */
@Entity
@Table(name="FI_PRODUCT_POINT_TEMP")

@XmlRootElement
public class FiProductPointTemp extends BaseObject implements Serializable {
    private Long tempId;
	...
	public boolean equals(Object o) {
        ...
        FiProductPointTemp pojo = (FiProductPointTemp) o;
