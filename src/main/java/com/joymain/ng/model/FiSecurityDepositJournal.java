...
@Entity
@Table(name="FI_SECURITY_DEPOSIT_JOURNAL")

@XmlRootElement
public class FiSecurityDepositJournal extends BaseObject implements Serializable {
    ...
    @Id      @Column(name="JOURNAL_ID", unique=true, nullable=false, precision=12, scale=0) @DocumentId    
    ...
    public boolean equals(Object o) {
        ...
        FiSecurityDepositJournal pojo = (FiSecurityDepositJournal) o;
