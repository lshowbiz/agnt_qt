...
@Controller
@RequestMapping("/jamMsnTypes*")
public class JamMsnTypeController {
    ...
    throws Exception {
        ...
        try {
            model.addAttribute(jamMsnTypeManager.search(query, JamMsnType.class));
        } catch (SearchException se) {
            model.addAttribute("searchError", se.getMessage());
            model.addAttribute(jamMsnTypeManager.getAll());
        }
        return model;
    }
}
