...
@Controller
@RequestMapping("/jpmWineTemplatePictures/")
public class JpmWineTemplatePictureController {
    ...
    throws Exception {
        ...
        try {
            model.addAttribute(jpmWineTemplatePictureManager.search(query, JpmWineTemplatePicture.class));
        } catch (SearchException se) {
            model.addAttribute("searchError", se.getMessage());
            model.addAttribute(jpmWineTemplatePictureManager.getAll());
        }
        return model;
    }
