...
@Controller
@RequestMapping("/jpmCouponInfoes/")
public class JpmCouponInfoController {
    ...
    throws Exception {
        ...
        try {
            model.addAttribute(jpmCouponInfoManager.search(query, JpmCouponInfo.class));
        } catch (SearchException se) {
            model.addAttribute("searchError", se.getMessage());
            model.addAttribute(jpmCouponInfoManager.getAll());
        }
        return model;
    }
