...
@Controller
@RequestMapping("/jpmConfigSpecDetaileds/")
public class JpmConfigSpecDetailedController {
    ...
    throws Exception {
        ...
        try {
            model.addAttribute(jpmConfigSpecDetailedManager.search(query, JpmConfigSpecDetailed.class));
        } catch (SearchException se) {
            model.addAttribute("searchError", se.getMessage());
            model.addAttribute(jpmConfigSpecDetailedManager.getAll());
        }
        return model;
    }
