...
@Controller
@RequestMapping("/jmiBlacklists*")
public class JmiBlacklistController {
    ...
    throws Exception {
        ...
        try {
            model.addAttribute(jmiBlacklistManager.search(query, JmiBlacklist.class));
        } catch (SearchException se) {
            model.addAttribute("searchError", se.getMessage());
            model.addAttribute(jmiBlacklistManager.getAll());
        }
        return model;
    }
}
