...
@Controller
@RequestMapping("/jbdSummaryLists*")
public class JbdSummaryListController {
    ...
    throws Exception {
        ...
        try {
            model.addAttribute(jbdSummaryListManager.search(query, JbdSummaryList.class));
        } catch (SearchException se) {
            model.addAttribute("searchError", se.getMessage());
            model.addAttribute(jbdSummaryListManager.getAll());
        }
        return model;
    }
}
