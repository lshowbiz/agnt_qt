...
@Controller
@RequestMapping("/jmiEcmallNotes/")
public class JmiEcmallNoteController {
    ...
    throws Exception {
        ...
        try {
            model.addAttribute(jmiEcmallNoteManager.search(query, JmiEcmallNote.class));
        } catch (SearchException se) {
            model.addAttribute("searchError", se.getMessage());
            model.addAttribute(jmiEcmallNoteManager.getAll());
        }
        return model;
    }
