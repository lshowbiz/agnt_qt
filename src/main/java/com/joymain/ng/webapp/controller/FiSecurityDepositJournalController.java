...
@Controller
@RequestMapping("/fiSecurityDepositJournals/")
public class FiSecurityDepositJournalController {
    ...
    throws Exception {
        ...
        try {
            model.addAttribute(fiSecurityDepositJournalManager.search(query, FiSecurityDepositJournal.class));
        } catch (SearchException se) {
            model.addAttribute("searchError", se.getMessage());
            model.addAttribute(fiSecurityDepositJournalManager.getAll());
        }
        return model;
    }
