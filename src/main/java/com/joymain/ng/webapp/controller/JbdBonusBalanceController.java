...
@Controller
@RequestMapping("/jbdBonusBalances/")
public class JbdBonusBalanceController {
    ...
    throws Exception {
        ...
        try {
            model.addAttribute(jbdBonusBalanceManager.search(query, JbdBonusBalance.class));
        } catch (SearchException se) {
            model.addAttribute("searchError", se.getMessage());
            model.addAttribute(jbdBonusBalanceManager.getAll());
        }
        return model;
    }
