...
@Controller
@RequestMapping("/jmiSmsNotes/")
public class JmiSmsNoteController {
    ...
    throws Exception {
        ...
        try {
            model.addAttribute(jmiSmsNoteManager.search(query, JmiSmsNote.class));
        } catch (SearchException se) {
            model.addAttribute("searchError", se.getMessage());
            model.addAttribute(jmiSmsNoteManager.getAll());
        }
        return model;
    }
