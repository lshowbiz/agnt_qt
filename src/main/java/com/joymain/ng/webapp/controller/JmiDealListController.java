...
@Controller
@RequestMapping("/jmiDealLists/")
public class JmiDealListController {
    ...
    throws Exception {
        ...
        try {
            model.addAttribute(jmiDealListManager.search(query, JmiDealList.class));
        } catch (SearchException se) {
            model.addAttribute("searchError", se.getMessage());
            model.addAttribute(jmiDealListManager.getAll());
        }
        return model;
    }
