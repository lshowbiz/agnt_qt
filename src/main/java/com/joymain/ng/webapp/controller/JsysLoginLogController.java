...
@Controller
@RequestMapping("/jsysLoginLogs/")
public class JsysLoginLogController {
    ...
    throws Exception {
        ...
        try {
            model.addAttribute(jsysLoginLogManager.search(query, JsysLoginLog.class));
        } catch (SearchException se) {
            model.addAttribute("searchError", se.getMessage());
            model.addAttribute(jsysLoginLogManager.getAll());
        }
        return model;
    }
