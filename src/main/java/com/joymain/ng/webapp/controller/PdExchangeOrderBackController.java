...
@Controller
@RequestMapping("/pdExchangeOrderBacks/")
public class PdExchangeOrderBackController {
    ...
    throws Exception {
        ...
        try {
            model.addAttribute(pdExchangeOrderBackManager.search(query, PdExchangeOrderBack.class));
        } catch (SearchException se) {
            model.addAttribute("searchError", se.getMessage());
            model.addAttribute(pdExchangeOrderBackManager.getAll());
        }
        return model;
    }
