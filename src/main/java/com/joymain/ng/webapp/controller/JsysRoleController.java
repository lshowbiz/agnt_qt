...
@Controller
@RequestMapping("/jsysRoles*")
public class JsysRoleController {
    ...
    throws Exception {
        ...
        try {
            model.addAttribute(jsysRoleManager.search(query, JsysRole.class));
        } catch (SearchException se) {
            model.addAttribute("searchError", se.getMessage());
            model.addAttribute(jsysRoleManager.getAll());
        }
        return model;
    }
}
